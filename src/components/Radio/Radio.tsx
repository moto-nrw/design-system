	...
	return (
		...
		>
			<input
				...
				id={inputId}
				name={name}
				className="size-[var(--radio-size)] rounded-full border border-[var(--semantic-color-border-strong)] accent-steel-900 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
				{...props}
			/>
