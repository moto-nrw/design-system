	...
	if (hoverable) {
		return (
			...
			>
				...
				<div className="absolute inset-0 rounded-[24px] bg-gradient-to-r from-transparent via-steel-400/20 to-transparent opacity-0 transition-opacity duration-150 pointer-events-none" />
			</div>
		);
	}
